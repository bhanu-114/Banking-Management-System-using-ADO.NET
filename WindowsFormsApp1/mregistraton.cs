...
{
    public partial class mregistraton : Form
    {
        public mregistraton()
        {
            InitializeComponent();
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            ...
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                ...
                try
                {
                    ...
                    string loginQuery = "INSERT INTO managerl (Username, Password) VALUES (@Username, @Password)";
                    ...
                    string registrationQuery = "INSERT INTO managerr (Username, FullName, Email, Phone) VALUES (@Username, @FullName, @Email, @Phone)";
